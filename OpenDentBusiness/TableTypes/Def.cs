...
namespace OpenDentBusiness {
	...
	public enum DefCat {
		...
		AppointmentColors,
		///<summary>18- Image categories. X = Show in Chart Module, F = Show in Patient Forms, L = Show in Patient Portal, P = Show in Patient Pictures,
		///S = Statements, T = Graphical Tooth Charts, R = Treatment Plans, E = Expanded, A = Payment Plans, C = Claim Attachments, B = Lab Cases.</summary>
		...
		TimeCardAdjTypes,
		///<summary>51 - Web Sched Existing Appt Types</summary>
	...
	///<summary>For DefCat MiscColors(21).</summary>

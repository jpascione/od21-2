...
namespace OpenDental {
	public partial class FormEServicesAutoMsgingAdvanced:FormODBase {
		...
		private void FillGrid() {
			...
			gridMain.ListGridColumns.Add(new GridColumn(Lan.g(this,"Send eReminder"),110,HorizontalAlignment.Center) { Tag=_listDontSendReminderNums});
			gridMain.ListGridColumns.Add(new GridColumn(Lan.g(this,"Send Automated Thank-You"),125,HorizontalAlignment.Center) { Tag=_listExcludeThanksNums});

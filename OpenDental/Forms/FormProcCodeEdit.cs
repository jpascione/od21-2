...
///<summary></summary>
	public partial class FormProcCodeEdit : FormODBase {
		...
		private void FormProcCodeEdit_Load(object sender, System.EventArgs e) {
			...
			checkIsTaxed.Checked=ProcCode.IsTaxed;
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			ProcCode.IsTaxed=checkIsTaxed.Checked;
			...
			if(ProcedureCodes.Update(ProcCode,_procCodeOld)) {//whether new or not.
				...
				secLog+=SecurityLogEntryHelper(_procCodeOld.IsTaxed.ToString(),ProcCode.IsTaxed.ToString(),"is taxed box");

	...
	public partial class FormRecallList:FormODBase {
		...
		private void FillRecalls() {
			...
			_getRecallTable=new Func<DataTable>(() => {
				...
				return Recalls.GetRecallList(datePickerRecalls.GetDateTimeFrom(),datePickerRecalls.GetDateTimeTo(),checkGroupFamiliesRecalls.Checked,
...
#region printHeading
		...
		private void FillGridReminders() {
			...
			progressOD.ActionMain=() => { 
				listRecent=Recalls.GetRecentRecalls(datePickerRemind.GetDateTimeFrom(),datePickerRemind.GetDateTimeTo(),comboClinicRemind.ListSelectedClinicNums);
				};
			progressOD.ShowDialogProgress();
			if(progressOD.IsCancelled){
				return;
		...
		private void FillReactivationGrid() {
			...
			ProgressOD progressOD=new ProgressOD();
			progressOD.ActionMain=() => { 
				tableReacts=Reactivations.GetReactivationList(datePickerReact.GetDateTimeTo(),datePickerReact.GetDateTimeFrom(),

...
namespace OpenDental {
	public class ClaimL {
		...
		private static void MakeEraClaimAutomationLog(Claim claimOld,Claim claimNew) {
			...
			stringBuilderLog.Append(Lan.g("X835","Claim payment received during automatic processing of ERA."));
			string old=Lan.g("X835","Old");
			string strNew=Lan.g("X835","new");
			string insurancePayment=Lan.g("X835","insurance payment:");
			string deductableApplied=Lan.g("X835","deductable applied:");
			string writeoff=Lan.g("X835","writeoff:");

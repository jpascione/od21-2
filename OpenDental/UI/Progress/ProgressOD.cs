...
namespace OpenDental.UI{
	...
	public class ProgressOD{
		...
		///<summary>Always true except in three places: db update and terminal transaction processing via PayConnect.  Do not set to false anywhere else.</summary>
		...
		public void ShowDialogProgress(){
			...
			if(formProgressAuto.ExceptionGenerated!=null){
				if(formProgressAuto.ExceptionGenerated.InnerException!=null){
					throw formProgressAuto.ExceptionGenerated.InnerException;//this can happen when methods are invoked by reflection
				}
				throw formProgressAuto.ExceptionGenerated;
			}
		}

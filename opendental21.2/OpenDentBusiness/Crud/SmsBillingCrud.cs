...
namespace OpenDentBusiness.Crud{
	public class SmsBillingCrud {
		...
		///<summary>Deletes many SmsBillings from the database.</summary>
		public static void DeleteMany(List<long> listSmsBillingNums) {
			if(listSmsBillingNums==null || listSmsBillingNums.Count==0) {
				return;
			}
			string command="DELETE FROM smsbilling "
				+"WHERE SmsBillingNum IN("+string.Join(",",listSmsBillingNums.Select(x => POut.Long(x)))+")";
			Db.NonQ(command);
		}

	...
	public class PayConnect {
			...
			Action<string> showError) 
		{
			try {
				...
				ms.Url=Introspection.GetOverride(Introspection.IntrospectionEntity.PayConnectWebServiceURL,"https://webservices.dentalxchange.com/merchant/MerchantService?wsdl");
				if(ODBuild.IsDebug()) {

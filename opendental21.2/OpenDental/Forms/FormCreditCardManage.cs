				...
				if(hasEdgeExpress) {
					...
					try {
						...
						//Card Not Present API
							...
							XWebResponse responseUrl=EdgeExpress.CNP.GetUrlForCreditCardAlias(PatCur.PatNum,CreditCardSource.EdgeExpressCNP,false);
							Cursor=Cursors.Default;
							...
							if(xWebResponseProcessed.TransactionStatus!=XWebTransactionStatus.EdgeExpressCompleteAliasCreated) {

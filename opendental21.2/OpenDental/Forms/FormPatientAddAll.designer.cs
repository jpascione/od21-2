namespace OpenDental {
	partial class FormPatientAddAll {
		...
		private void InitializeComponent() {
			...
			this.labelBirthAge = new System.Windows.Forms.Label();
			this.labelGenPos = new System.Windows.Forms.Label();
			this.listPosition1 = new OpenDental.UI.ListBoxOD();
			this.listGender1 = new OpenDental.UI.ListBoxOD();
			...
			this.listPosition2 = new OpenDental.UI.ListBoxOD();
			this.listGender2 = new OpenDental.UI.ListBoxOD();
			...
			this.listGender3 = new OpenDental.UI.ListBoxOD();
			...
			this.listGender4 = new OpenDental.UI.ListBoxOD();
			...
			this.labelGroupNum1 = new System.Windows.Forms.Label();
			...
			this.labelEmployer1 = new System.Windows.Forms.Label();
			this.textSubscriberID1 = new System.Windows.Forms.TextBox();
			this.labelSubscriberID1 = new System.Windows.Forms.Label();
			this.comboSubscriber1 = new System.Windows.Forms.ComboBox();
			this.labelSubscriber1 = new System.Windows.Forms.Label();
			...
			this.textPhone2 = new OpenDental.ValidPhone();
			...
			this.butClearReferralSource = new OpenDental.UI.Button();
			...
			this.textSSN1 = new System.Windows.Forms.TextBox();
			this.textSSN2 = new System.Windows.Forms.TextBox();
			this.textSSN3 = new System.Windows.Forms.TextBox();
			this.textSSN4 = new System.Windows.Forms.TextBox();
			this.textSSN5 = new System.Windows.Forms.TextBox();
			this.listStatus1 = new OpenDental.UI.ListBoxOD();
			this.listStatus2 = new OpenDental.UI.ListBoxOD();
			this.listStatus3 = new OpenDental.UI.ListBoxOD();
			this.listStatus4 = new OpenDental.UI.ListBoxOD();
			this.listStatus5 = new OpenDental.UI.ListBoxOD();
			this.comboBillType1 = new System.Windows.Forms.ComboBox();
			this.comboBillType2 = new System.Windows.Forms.ComboBox();
			this.comboBillType3 = new System.Windows.Forms.ComboBox();
			this.comboBillType4 = new System.Windows.Forms.ComboBox();
			this.comboBillType5 = new System.Windows.Forms.ComboBox();
			...
			this.comboClinic5 = new OpenDental.UI.ComboBoxClinicPicker();
			this.comboClinic4 = new OpenDental.UI.ComboBoxClinicPicker();
			...
			this.textWirelessPhone1 = new OpenDental.ValidPhone();
			this.textWirelessPhone2 = new OpenDental.ValidPhone();
			this.textWirelessPhone3 = new OpenDental.ValidPhone();
			...
			// textLName4
			// 
			this.textLName4.Location = new System.Drawing.Point(580, 23);
			...
			this.textLName4.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// textLName5
			// 
			this.textLName5.Location = new System.Drawing.Point(733, 23);
			...
			this.textLName5.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// textLName1
			// 
			this.textLName1.Location = new System.Drawing.Point(121, 23);
			...
			this.textLName1.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// labelLName
			// 
			this.labelLName.Location = new System.Drawing.Point(2, 24);
			this.labelLName.Name = "labelLName";
			this.labelLName.Size = new System.Drawing.Size(118, 16);
			this.labelLName.TabIndex = 5;
			this.labelLName.Text = "Last Name";
			this.labelLName.TextAlign = System.Drawing.ContentAlignment.BottomRight;
			// 
			// textFName1
			// 
			this.textFName1.Location = new System.Drawing.Point(121, 44);
			...
			this.textFName1.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// labelFName
			// 
			this.labelFName.Location = new System.Drawing.Point(2, 45);
			this.labelFName.Name = "labelFName";
			this.labelFName.Size = new System.Drawing.Size(118, 16);
			this.labelFName.TabIndex = 7;
			this.labelFName.Text = "First Name";
			this.labelFName.TextAlign = System.Drawing.ContentAlignment.BottomRight;
			// 
			// labelBirthAge
			// 
			this.labelBirthAge.Location = new System.Drawing.Point(2, 111);
			...
			this.labelBirthAge.Text = "Birthdate / Age";
			this.labelBirthAge.TextAlign = System.Drawing.ContentAlignment.BottomRight;
			// 
			// labelGenPos
			// 
			this.labelGenPos.Location = new System.Drawing.Point(2, 68);
			this.labelGenPos.Name = "labelGenPos";
			this.labelGenPos.Size = new System.Drawing.Size(118, 16);
			this.labelGenPos.TabIndex = 15;
			this.labelGenPos.Text = "Gender / Position";
			this.labelGenPos.TextAlign = System.Drawing.ContentAlignment.BottomRight;
			// 
			// listPosition1
			// 
			...
			this.listPosition1.ItemStrings = new string[] {
        "Single",
        "Married"};
			this.listPosition1.Location = new System.Drawing.Point(183, 65);
			...
			// listGender1
			// 
			this.listGender1.ItemStrings = new string[] {
        "Male",
        "Female",
        "Unknown"};
			this.listGender1.Location = new System.Drawing.Point(121, 65);
			...
			this.textHmPhone.Size = new System.Drawing.Size(134, 20);
			...
			this.comboZip.Size = new System.Drawing.Size(134, 21);
			...
			this.textCountry.Size = new System.Drawing.Size(213, 20);
			this.textCountry.TabIndex = 5;
			this.textCountry.TextChanged += new System.EventHandler(this.textState_TextChanged);
			this.textCountry.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// textState
			// 
			...
			// labelAddress2
			// 
			this.labelAddress2.Location = new System.Drawing.Point(3, 73);
			this.labelAddress2.Name = "labelAddress2";
			this.labelAddress2.Size = new System.Drawing.Size(123, 14);
			...
			this.textAddress2.Size = new System.Drawing.Size(275, 20);
			...
			// labelHmPhone
			// 
			this.labelHmPhone.Location = new System.Drawing.Point(3, 31);
			this.labelHmPhone.Name = "labelHmPhone";
			this.labelHmPhone.Size = new System.Drawing.Size(123, 14);
			this.labelHmPhone.TabIndex = 15;
			...
			this.textCity.Size = new System.Drawing.Size(134, 20);
			...
			// labelAddress
			// 
			this.labelAddress.Location = new System.Drawing.Point(3, 52);
			this.labelAddress.Name = "labelAddress";
			this.labelAddress.Size = new System.Drawing.Size(123, 14);
			...
			// labelSecProv
			// 
			this.labelSecProv.Location = new System.Drawing.Point(2, 174);
			...
			// labelPriProv
			// 
			this.labelPriProv.Location = new System.Drawing.Point(2, 153);
			...
			this.comboSecProv1.Location = new System.Drawing.Point(121, 173);
			...
			this.comboPriProv1.Location = new System.Drawing.Point(121, 151);
			...
			this.checkInsOne1.Location = new System.Drawing.Point(121, 130);
			...
			this.checkInsTwo1.Location = new System.Drawing.Point(164, 130);
			...
			this.checkInsTwo2.Location = new System.Drawing.Point(317, 130);
			...
			this.checkInsOne2.Location = new System.Drawing.Point(274, 130);
			...
			this.listPosition2.ItemStrings = new string[] {
        "Single",
        "Married"};
			this.listPosition2.Location = new System.Drawing.Point(336, 65);
			...
			// listGender2
			// 
			this.listGender2.ItemStrings = new string[] {
        "Male",
        "Female",
        "Unknown"};
			this.listGender2.Location = new System.Drawing.Point(274, 65);
			...
			// textFName2
			// 
			this.textFName2.Location = new System.Drawing.Point(274, 44);
			...
			this.textFName2.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// textLName2
			// 
			this.textLName2.Location = new System.Drawing.Point(274, 23);
			...
			this.textLName2.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// checkInsTwo3
			// 
			this.checkInsTwo3.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.checkInsTwo3.Location = new System.Drawing.Point(470, 130);
			...
			this.checkInsOne3.Location = new System.Drawing.Point(427, 130);
			...
			// listGender3
			// 
			this.listGender3.ItemStrings = new string[] {
        "Male",
        "Female",
        "Unknown"};
			this.listGender3.Location = new System.Drawing.Point(427, 65);
			...
			// textFName3
			// 
			this.textFName3.Location = new System.Drawing.Point(427, 44);
			...
			this.textFName3.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// textLName3
			// 
			this.textLName3.Location = new System.Drawing.Point(427, 23);
			...
			this.textLName3.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// checkInsTwo4
			// 
			this.checkInsTwo4.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.checkInsTwo4.Location = new System.Drawing.Point(623, 130);
			...
			this.checkInsOne4.Location = new System.Drawing.Point(580, 130);
			...
			// listGender4
			// 
			this.listGender4.ItemStrings = new string[] {
        "Male",
        "Female",
        "Unknown"};
			this.listGender4.Location = new System.Drawing.Point(580, 65);
			...
			// textFName4
			// 
			this.textFName4.Location = new System.Drawing.Point(580, 44);
			...
			this.textFName4.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// checkInsTwo5
			// 
			this.checkInsTwo5.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.checkInsTwo5.Location = new System.Drawing.Point(776, 130);
			...
			this.checkInsOne5.Location = new System.Drawing.Point(733, 130);
			...
			// listGender5
			// 
			this.listGender5.ItemStrings = new string[] {
        "Male",
        "Female",
        "Unknown"};
			this.listGender5.Location = new System.Drawing.Point(733, 65);
			...
			// textFName5
			// 
			this.textFName5.Location = new System.Drawing.Point(733, 44);
			...
			this.textFName5.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// labelAddrNotes
			// 
			this.labelAddrNotes.Location = new System.Drawing.Point(3, 552);
			this.labelAddrNotes.Name = "labelAddrNotes";
			this.labelAddrNotes.Size = new System.Drawing.Size(153, 58);
			this.labelAddrNotes.TabIndex = 69;
			this.labelAddrNotes.Text = "Address and Phone Notes";
			this.labelAddrNotes.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// textPhone1
			// 
			this.textPhone1.Location = new System.Drawing.Point(120, 95);
			this.textPhone1.MaxLength = 30;
			this.textPhone1.Name = "textPhone1";
			this.textPhone1.Size = new System.Drawing.Size(150, 20);
			this.textPhone1.TabIndex = 4;
			this.textPhone1.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// labelPhone1
			// 
			this.labelPhone1.Location = new System.Drawing.Point(6, 98);
			this.labelPhone1.Name = "labelPhone1";
			this.labelPhone1.Size = new System.Drawing.Size(113, 15);
			this.labelPhone1.TabIndex = 155;
			this.labelPhone1.Text = "Phone";
			this.labelPhone1.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// textCarrier1
			// 
			...
			this.textCarrier1.Location = new System.Drawing.Point(120, 75);
			...
			// labelCarrier1
			// 
			this.labelCarrier1.Location = new System.Drawing.Point(6, 77);
			this.labelCarrier1.Name = "labelCarrier1";
			this.labelCarrier1.Size = new System.Drawing.Size(113, 15);
			this.labelCarrier1.TabIndex = 156;
			this.labelCarrier1.Text = "Carrier";
			this.labelCarrier1.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// groupIns1
			// 
			this.groupIns1.Controls.Add(this.butPick1);
			this.groupIns1.Controls.Add(this.textGroupNum1);
			this.groupIns1.Controls.Add(this.labelGroupNum1);
			this.groupIns1.Controls.Add(this.labelGroupName1);
			this.groupIns1.Controls.Add(this.textGroupName1);
			this.groupIns1.Controls.Add(this.textEmployer1);
			this.groupIns1.Controls.Add(this.labelEmployer1);
			this.groupIns1.Controls.Add(this.textSubscriberID1);
			this.groupIns1.Controls.Add(this.labelSubscriberID1);
			this.groupIns1.Controls.Add(this.comboSubscriber1);
			this.groupIns1.Controls.Add(this.labelSubscriber1);
			this.groupIns1.Controls.Add(this.textPhone1);
			this.groupIns1.Controls.Add(this.labelCarrier1);
			this.groupIns1.Controls.Add(this.labelPhone1);
			this.groupIns1.Controls.Add(this.textCarrier1);
			this.groupIns1.Location = new System.Drawing.Point(455, 376);
			this.groupIns1.Name = "groupIns1";
			this.groupIns1.Size = new System.Drawing.Size(427, 167);
			...
			this.butPick1.Location = new System.Drawing.Point(330, 31);
			...
			// textGroupNum1
			// 
			this.textGroupNum1.Location = new System.Drawing.Point(120, 135);
			this.textGroupNum1.MaxLength = 20;
			this.textGroupNum1.Name = "textGroupNum1";
			this.textGroupNum1.Size = new System.Drawing.Size(150, 20);
			this.textGroupNum1.TabIndex = 6;
			this.textGroupNum1.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// labelGroupNum1
			// 
			this.labelGroupNum1.Location = new System.Drawing.Point(6, 138);
			this.labelGroupNum1.Name = "labelGroupNum1";
			this.labelGroupNum1.Size = new System.Drawing.Size(113, 15);
			this.labelGroupNum1.TabIndex = 167;
			this.labelGroupNum1.Text = "Group Num";
			this.labelGroupNum1.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// labelGroupName1
			// 
			this.labelGroupName1.Location = new System.Drawing.Point(6, 118);
			this.labelGroupName1.Name = "labelGroupName1";
			this.labelGroupName1.Size = new System.Drawing.Size(113, 15);
			this.labelGroupName1.TabIndex = 166;
			this.labelGroupName1.Text = "Group Name";
			this.labelGroupName1.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// textGroupName1
			// 
			this.textGroupName1.Location = new System.Drawing.Point(120, 115);
			this.textGroupName1.MaxLength = 50;
			this.textGroupName1.Name = "textGroupName1";
			this.textGroupName1.Size = new System.Drawing.Size(150, 20);
			this.textGroupName1.TabIndex = 5;
			this.textGroupName1.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// textEmployer1
			// 
			this.textEmployer1.Location = new System.Drawing.Point(120, 55);
			...
			// labelEmployer1
			// 
			this.labelEmployer1.Location = new System.Drawing.Point(6, 57);
			this.labelEmployer1.Name = "labelEmployer1";
			this.labelEmployer1.Size = new System.Drawing.Size(113, 15);
			this.labelEmployer1.TabIndex = 162;
			this.labelEmployer1.Text = "Employer";
			this.labelEmployer1.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// textSubscriberID1
			// 
			this.textSubscriberID1.Location = new System.Drawing.Point(120, 35);
			this.textSubscriberID1.MaxLength = 20;
			this.textSubscriberID1.Name = "textSubscriberID1";
			this.textSubscriberID1.Size = new System.Drawing.Size(150, 20);
			this.textSubscriberID1.TabIndex = 1;
			this.textSubscriberID1.Leave += new System.EventHandler(this.textBox_Leave);
			// 
			// labelSubscriberID1
			// 
			this.labelSubscriberID1.Location = new System.Drawing.Point(6, 37);
			this.labelSubscriberID1.Name = "labelSubscriberID1";
			this.labelSubscriberID1.Size = new System.Drawing.Size(113, 15);
			this.labelSubscriberID1.TabIndex = 160;
			this.labelSubscriberID1.Text = "Subscriber ID";
			this.labelSubscriberID1.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// comboSubscriber1
			// 
			...
			this.comboSubscriber1.Location = new System.Drawing.Point(120, 14);
			...
			// labelSubscriber1
			// 
			this.labelSubscriber1.Location = new System.Drawing.Point(6, 18);
			this.labelSubscriber1.Name = "labelSubscriber1";
			this.labelSubscriber1.Size = new System.Drawing.Size(113, 15);
			this.labelSubscriber1.TabIndex = 157;
			this.labelSubscriber1.Text = "Subscriber";
			this.labelSubscriber1.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// label20
			// 
			this.label20.Location = new System.Drawing.Point(491, 68);
			...
			// label21
			// 
			this.label21.Location = new System.Drawing.Point(644, 68);
			...
			// label22
			// 
			this.label22.Location = new System.Drawing.Point(797, 68);
			...
			this.groupIns2.Location = new System.Drawing.Point(455, 549);
			this.groupIns2.Name = "groupIns2";
			this.groupIns2.Size = new System.Drawing.Size(427, 167);
			...
			this.butPick2.Location = new System.Drawing.Point(330, 31);
			...
			// textGroupNum2
			// 
			this.textGroupNum2.Location = new System.Drawing.Point(120, 135);
			this.textGroupNum2.MaxLength = 20;
			this.textGroupNum2.Name = "textGroupNum2";
			this.textGroupNum2.Size = new System.Drawing.Size(150, 20);
			...
			this.label24.Size = new System.Drawing.Size(113, 15);
			...
			// textGroupName2
			// 
			this.textGroupName2.Location = new System.Drawing.Point(120, 115);
			this.textGroupName2.MaxLength = 50;
			this.textGroupName2.Name = "textGroupName2";
			this.textGroupName2.Size = new System.Drawing.Size(150, 20);
			this.textGroupName2.TabIndex = 5;
			// 
			// textEmployer2
			// 
			this.textEmployer2.Location = new System.Drawing.Point(120, 55);
			...
			// textSubscriberID2
			// 
			this.textSubscriberID2.Location = new System.Drawing.Point(120, 35);
			this.textSubscriberID2.MaxLength = 20;
			this.textSubscriberID2.Name = "textSubscriberID2";
			this.textSubscriberID2.Size = new System.Drawing.Size(150, 20);
			...
			this.comboSubscriber2.Location = new System.Drawing.Point(120, 14);
			...
			// textPhone2
			// 
			this.textPhone2.Location = new System.Drawing.Point(120, 95);
			this.textPhone2.MaxLength = 30;
			this.textPhone2.Name = "textPhone2";
			this.textPhone2.Size = new System.Drawing.Size(150, 20);
			...
			// label29
			// 
			this.label29.Location = new System.Drawing.Point(6, 98);
			...
			this.textCarrier2.Location = new System.Drawing.Point(120, 75);
			...
			// textAge1
			// 
			this.textAge1.Location = new System.Drawing.Point(204, 110);
			...
			this.textAge1.TabStop = false;
			// 
			// textAge2
			// 
			this.textAge2.Location = new System.Drawing.Point(357, 110);
			...
			this.textAge2.TabStop = false;
			// 
			// textAge3
			// 
			this.textAge3.Location = new System.Drawing.Point(510, 110);
			...
			this.textAge3.TabStop = false;
			// 
			// textAge4
			// 
			this.textAge4.Location = new System.Drawing.Point(663, 110);
			...
			this.textAge4.TabStop = false;
			// 
			// textAge5
			// 
			this.textAge5.Location = new System.Drawing.Point(816, 110);
			...
			this.comboSecProv2.Location = new System.Drawing.Point(274, 173);
			...
			this.comboPriProv2.Location = new System.Drawing.Point(274, 151);
			...
			this.comboSecProv3.Location = new System.Drawing.Point(427, 173);
			...
			this.comboPriProv3.Location = new System.Drawing.Point(427, 151);
			...
			this.comboSecProv4.Location = new System.Drawing.Point(580, 173);
			...
			this.comboPriProv4.Location = new System.Drawing.Point(580, 151);
			...
			this.comboSecProv5.Location = new System.Drawing.Point(733, 173);
			...
			this.comboPriProv5.Location = new System.Drawing.Point(733, 151);
			...
			// labelReferred
			// 
			this.labelReferred.Location = new System.Drawing.Point(3, 622);
			this.labelReferred.Name = "labelReferred";
			this.labelReferred.Size = new System.Drawing.Size(153, 14);
			this.labelReferred.TabIndex = 183;
			this.labelReferred.Text = "Referred From";
			this.labelReferred.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// textReferredFrom
			// 
			this.textReferredFrom.Location = new System.Drawing.Point(157, 618);
			...
			this.textReferredFrom.Size = new System.Drawing.Size(231, 20);
			this.textReferredFrom.TabIndex = 181;
			...
			this.butClearReferralSource.TabIndex = 184;
			this.butClearReferralSource.TabStop = false;
			this.butClearReferralSource.Click += new System.EventHandler(this.butClearReferralSource_Click);
			// 
			// butReferredFrom
			// 
			this.butReferredFrom.Location = new System.Drawing.Point(390, 618);
			this.butReferredFrom.Name = "butReferredFrom";
			this.butReferredFrom.Size = new System.Drawing.Size(21, 20);
			this.butReferredFrom.TabIndex = 182;
			...
			this.textAddrNotes.Location = new System.Drawing.Point(157, 551);
			...
			// textBirthdate5
			// 
			this.textBirthdate5.Location = new System.Drawing.Point(733, 110);
			...
			this.textBirthdate5.Leave += new System.EventHandler(this.textBox_Leave);
			this.textBirthdate5.Validated += new System.EventHandler(this.textBirthdate5_Validated);
			// 
			// textBirthdate4
			// 
			this.textBirthdate4.Location = new System.Drawing.Point(580, 110);
			...
			this.textBirthdate4.Leave += new System.EventHandler(this.textBox_Leave);
			this.textBirthdate4.Validated += new System.EventHandler(this.textBirthdate4_Validated);
			// 
			// textBirthdate3
			// 
			this.textBirthdate3.Location = new System.Drawing.Point(427, 110);
			...
			this.textBirthdate3.Leave += new System.EventHandler(this.textBox_Leave);
			this.textBirthdate3.Validated += new System.EventHandler(this.textBirthdate3_Validated);
			// 
			// textBirthdate2
			// 
			this.textBirthdate2.Location = new System.Drawing.Point(274, 110);
			...
			this.textBirthdate2.Leave += new System.EventHandler(this.textBox_Leave);
			this.textBirthdate2.Validated += new System.EventHandler(this.textBirthdate2_Validated);
			// 
			// textBirthdate1
			// 
			this.textBirthdate1.Location = new System.Drawing.Point(121, 110);
			...
			// textEmail1
			// 
			this.textEmail1.Location = new System.Drawing.Point(121, 195);
			this.textEmail1.MaxLength = 100;
			...
			// textEmail2
			// 
			this.textEmail2.Location = new System.Drawing.Point(274, 195);
			this.textEmail2.MaxLength = 100;
			...
			// textEmail3
			// 
			this.textEmail3.Location = new System.Drawing.Point(427, 195);
			this.textEmail3.MaxLength = 100;
			...
			// textEmail4
			// 
			this.textEmail4.Location = new System.Drawing.Point(580, 195);
			this.textEmail4.MaxLength = 100;
			...
			// textEmail5
			// 
			this.textEmail5.Location = new System.Drawing.Point(733, 195);
			this.textEmail5.MaxLength = 100;
			...
			// textSSN1
			// 
			this.textSSN1.Location = new System.Drawing.Point(121, 255);
			this.textSSN1.MaxLength = 100;
			...
			// textSSN2
			// 
			this.textSSN2.Location = new System.Drawing.Point(274, 255);
			this.textSSN2.MaxLength = 100;
			...
			// textSSN3
			// 
			this.textSSN3.Location = new System.Drawing.Point(427, 255);
			this.textSSN3.MaxLength = 100;
			...
			// textSSN4
			// 
			this.textSSN4.Location = new System.Drawing.Point(580, 255);
			this.textSSN4.MaxLength = 100;
			...
			// textSSN5
			// 
			this.textSSN5.Location = new System.Drawing.Point(733, 255);
			this.textSSN5.MaxLength = 100;
			...
			// listStatus1
			// 
			this.listStatus1.Location = new System.Drawing.Point(121, 276);
			this.listStatus1.Name = "listStatus1";
			this.listStatus1.Size = new System.Drawing.Size(105, 56);
			this.listStatus1.TabIndex = 205;
			// 
			// listStatus2
			// 
			this.listStatus2.Location = new System.Drawing.Point(274, 276);
			this.listStatus2.Name = "listStatus2";
			this.listStatus2.Size = new System.Drawing.Size(105, 56);
			this.listStatus2.TabIndex = 206;
			// 
			// listStatus3
			// 
			this.listStatus3.Location = new System.Drawing.Point(427, 276);
			this.listStatus3.Name = "listStatus3";
			this.listStatus3.Size = new System.Drawing.Size(105, 56);
			this.listStatus3.TabIndex = 207;
			// 
			// listStatus4
			// 
			this.listStatus4.Location = new System.Drawing.Point(580, 276);
			this.listStatus4.Name = "listStatus4";
			this.listStatus4.Size = new System.Drawing.Size(105, 56);
			this.listStatus4.TabIndex = 208;
			// 
			// listStatus5
			// 
			this.listStatus5.Location = new System.Drawing.Point(733, 276);
			this.listStatus5.Name = "listStatus5";
			this.listStatus5.Size = new System.Drawing.Size(105, 56);
			this.listStatus5.TabIndex = 209;
			// 
			// comboBillType1
			// 
			this.comboBillType1.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBillType1.FormattingEnabled = true;
			this.comboBillType1.Location = new System.Drawing.Point(121, 334);
			this.comboBillType1.MaxDropDownItems = 30;
			this.comboBillType1.Name = "comboBillType1";
			this.comboBillType1.Size = new System.Drawing.Size(149, 21);
			this.comboBillType1.TabIndex = 210;
			this.comboBillType1.SelectionChangeCommitted += new System.EventHandler(this.comboBillType1_SelectionChangeCommitted);
			// 
			// comboBillType2
			// 
			this.comboBillType2.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBillType2.FormattingEnabled = true;
			this.comboBillType2.Location = new System.Drawing.Point(274, 334);
			this.comboBillType2.MaxDropDownItems = 30;
			this.comboBillType2.Name = "comboBillType2";
			this.comboBillType2.Size = new System.Drawing.Size(149, 21);
			this.comboBillType2.TabIndex = 211;
			// 
			// comboBillType3
			// 
			this.comboBillType3.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBillType3.FormattingEnabled = true;
			this.comboBillType3.Location = new System.Drawing.Point(427, 334);
			this.comboBillType3.MaxDropDownItems = 30;
			this.comboBillType3.Name = "comboBillType3";
			this.comboBillType3.Size = new System.Drawing.Size(149, 21);
			this.comboBillType3.TabIndex = 212;
			// 
			// comboBillType4
			// 
			this.comboBillType4.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBillType4.FormattingEnabled = true;
			this.comboBillType4.Location = new System.Drawing.Point(580, 334);
			this.comboBillType4.MaxDropDownItems = 30;
			this.comboBillType4.Name = "comboBillType4";
			this.comboBillType4.Size = new System.Drawing.Size(149, 21);
			this.comboBillType4.TabIndex = 213;
			// 
			// comboBillType5
			// 
			this.comboBillType5.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBillType5.FormattingEnabled = true;
			this.comboBillType5.Location = new System.Drawing.Point(733, 334);
			this.comboBillType5.MaxDropDownItems = 30;
			this.comboBillType5.Name = "comboBillType5";
			this.comboBillType5.Size = new System.Drawing.Size(149, 21);
			this.comboBillType5.TabIndex = 214;
			// 
			// labelEmail
			// 
			this.labelEmail.Location = new System.Drawing.Point(2, 196);
			this.labelEmail.Name = "labelEmail";
			this.labelEmail.Size = new System.Drawing.Size(118, 16);
			this.labelEmail.TabIndex = 205;
			this.labelEmail.Text = "E-mail Address";
			this.labelEmail.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// labelSSN
			// 
			this.labelSSN.Location = new System.Drawing.Point(2, 256);
			this.labelSSN.Name = "labelSSN";
			this.labelSSN.Size = new System.Drawing.Size(118, 16);
			this.labelSSN.TabIndex = 206;
			this.labelSSN.Text = "SS#";
			this.labelSSN.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// labelStatus
			// 
			this.labelStatus.Location = new System.Drawing.Point(2, 276);
			this.labelStatus.Name = "labelStatus";
			this.labelStatus.Size = new System.Drawing.Size(118, 16);
			this.labelStatus.TabIndex = 207;
			this.labelStatus.Text = "Status";
			this.labelStatus.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// labelBillType
			// 
			this.labelBillType.Location = new System.Drawing.Point(2, 335);
			this.labelBillType.Name = "labelBillType";
			this.labelBillType.Size = new System.Drawing.Size(118, 16);
			this.labelBillType.TabIndex = 208;
			...
			this.butAddComm.TabIndex = 209;
			this.butAddComm.Text = "Co&mm";
			this.butAddComm.Click += new System.EventHandler(this.butAddComm_Click);
			// 
			// comboClinic5
			// 
			this.comboClinic5.Location = new System.Drawing.Point(733, 356);
			this.comboClinic5.Name = "comboClinic5";
			this.comboClinic5.ShowLabel = false;
			this.comboClinic5.Size = new System.Drawing.Size(149, 21);
			this.comboClinic5.TabIndex = 219;
			this.comboClinic5.SelectionChangeCommitted += new System.EventHandler(this.comboClinic_SelectionChangeCommitted);
			// 
			// comboClinic4
			// 
			this.comboClinic4.Location = new System.Drawing.Point(580, 356);
			this.comboClinic4.Name = "comboClinic4";
			this.comboClinic4.ShowLabel = false;
			this.comboClinic4.Size = new System.Drawing.Size(149, 21);
			this.comboClinic4.TabIndex = 218;
			this.comboClinic4.SelectionChangeCommitted += new System.EventHandler(this.comboClinic_SelectionChangeCommitted);
			// 
			// comboClinic3
			// 
			this.comboClinic3.Location = new System.Drawing.Point(427, 356);
			this.comboClinic3.Name = "comboClinic3";
			this.comboClinic3.ShowLabel = false;
			this.comboClinic3.Size = new System.Drawing.Size(149, 21);
			this.comboClinic3.TabIndex = 217;
			this.comboClinic3.SelectionChangeCommitted += new System.EventHandler(this.comboClinic_SelectionChangeCommitted);
			// 
			// comboClinic2
			// 
			this.comboClinic2.Location = new System.Drawing.Point(274, 356);
			this.comboClinic2.Name = "comboClinic2";
			this.comboClinic2.ShowLabel = false;
			this.comboClinic2.Size = new System.Drawing.Size(149, 21);
			this.comboClinic2.TabIndex = 216;
			this.comboClinic2.SelectionChangeCommitted += new System.EventHandler(this.comboClinic_SelectionChangeCommitted);
			// 
			// comboClinic1
			// 
			this.comboClinic1.Location = new System.Drawing.Point(121, 356);
			this.comboClinic1.Name = "comboClinic1";
			this.comboClinic1.ShowLabel = false;
			this.comboClinic1.Size = new System.Drawing.Size(149, 21);
			this.comboClinic1.TabIndex = 215;
			this.comboClinic1.SelectionChangeCommitted += new System.EventHandler(this.comboClinic_SelectionChangeCommitted);
			// 
			// labelWirelessPhone
			// 
			this.labelWirelessPhone.Location = new System.Drawing.Point(5, 218);
			this.labelWirelessPhone.Name = "labelWirelessPhone";
			this.labelWirelessPhone.Size = new System.Drawing.Size(115, 14);
			this.labelWirelessPhone.TabIndex = 216;
			this.labelWirelessPhone.Text = "Wireless Phone";
			this.labelWirelessPhone.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// textWirelessPhone1
			// 
			this.textWirelessPhone1.Location = new System.Drawing.Point(121, 216);
			this.textWirelessPhone1.MaxLength = 30;
			this.textWirelessPhone1.Name = "textWirelessPhone1";
			...
			// textWirelessPhone2
			// 
			this.textWirelessPhone2.Location = new System.Drawing.Point(274, 216);
			this.textWirelessPhone2.MaxLength = 100;
			...
			// textWirelessPhone3
			// 
			this.textWirelessPhone3.Location = new System.Drawing.Point(427, 216);
			this.textWirelessPhone3.MaxLength = 100;
			...
			// textWirelessPhone4
			// 
			this.textWirelessPhone4.Location = new System.Drawing.Point(580, 216);
			this.textWirelessPhone4.MaxLength = 100;
			...
			// textWirelessPhone5
			// 
			this.textWirelessPhone5.Location = new System.Drawing.Point(733, 216);
			this.textWirelessPhone5.MaxLength = 100;
			...
			// labelTextOk
			// 
			this.labelTextOk.Location = new System.Drawing.Point(56, 238);
			this.labelTextOk.Name = "labelTextOk";
			this.labelTextOk.Size = new System.Drawing.Size(64, 14);
			this.labelTextOk.TabIndex = 217;
			...
			// labelClinic
			// 
			this.labelClinic.Location = new System.Drawing.Point(28, 357);
			this.labelClinic.Name = "labelClinic";
			this.labelClinic.Size = new System.Drawing.Size(92, 16);
			this.labelClinic.TabIndex = 220;
			...
			this.Controls.Add(this.comboClinic3);
			this.Controls.Add(this.comboClinic2);
			this.Controls.Add(this.comboClinic1);
			this.Controls.Add(this.butAddComm);
			this.Controls.Add(this.labelBillType);
			this.Controls.Add(this.labelStatus);
			this.Controls.Add(this.labelSSN);
			this.Controls.Add(this.labelEmail);
			this.Controls.Add(this.comboBillType5);
			this.Controls.Add(this.comboBillType4);
			this.Controls.Add(this.comboBillType3);
			this.Controls.Add(this.comboBillType2);
			this.Controls.Add(this.comboBillType1);
			this.Controls.Add(this.listStatus5);
			this.Controls.Add(this.listStatus4);
			this.Controls.Add(this.listStatus3);
			this.Controls.Add(this.listStatus2);
			this.Controls.Add(this.listStatus1);
			this.Controls.Add(this.textSSN5);
			this.Controls.Add(this.textSSN4);
			this.Controls.Add(this.textSSN3);
			this.Controls.Add(this.textSSN2);
			this.Controls.Add(this.textSSN1);
			this.Controls.Add(this.textEmail5);
			this.Controls.Add(this.textEmail4);
			this.Controls.Add(this.textEmail3);
			this.Controls.Add(this.textEmail2);
			this.Controls.Add(this.textEmail1);
			this.Controls.Add(this.labelRequiredFields);
			this.Controls.Add(this.butClearReferralSource);
			...
			this.Controls.Add(this.labelSecProv);
			...
			this.Controls.Add(this.labelAddrNotes);
			...
			this.Controls.Add(this.labelGenPos);
			this.Controls.Add(this.listPosition1);
			this.Controls.Add(this.listGender1);
			this.Controls.Add(this.labelBirthAge);
			this.Controls.Add(this.textBirthdate1);
			this.Controls.Add(this.labelFName);
			this.Controls.Add(this.textFName1);
			this.Controls.Add(this.labelLName);
			this.Controls.Add(this.labelWirelessPhone);
			this.Controls.Add(this.textWirelessPhone1);
			this.Controls.Add(this.textWirelessPhone2);
			this.Controls.Add(this.textWirelessPhone3);
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FormPatientAddAll_FormClosing);
		...
		private System.Windows.Forms.Label labelBirthAge;
		private System.Windows.Forms.Label labelGenPos;
		private OpenDental.UI.ListBoxOD listPosition1;
		private OpenDental.UI.ListBoxOD listGender1;
		private System.Windows.Forms.GroupBox groupBox1;
		private System.Windows.Forms.Label labelSecProv;
		...
		private OpenDental.UI.ListBoxOD listPosition2;
		private OpenDental.UI.ListBoxOD listGender2;
		...
		private OpenDental.UI.ListBoxOD listGender3;
		...
		private OpenDental.UI.ListBoxOD listGender4;
		...
		private System.Windows.Forms.TextBox textReferredFrom;
		private UI.Button butClearReferralSource;
		...
		private System.Windows.Forms.TextBox textEmail3;
		private System.Windows.Forms.TextBox textEmail4;
		private System.Windows.Forms.TextBox textEmail5;
		private System.Windows.Forms.TextBox textSSN1;
		private System.Windows.Forms.TextBox textSSN2;
		private System.Windows.Forms.TextBox textSSN3;
		private System.Windows.Forms.TextBox textSSN4;
		private System.Windows.Forms.TextBox textSSN5;
		private OpenDental.UI.ListBoxOD listStatus1;
		private OpenDental.UI.ListBoxOD listStatus2;
		private OpenDental.UI.ListBoxOD listStatus3;
		private OpenDental.UI.ListBoxOD listStatus4;
		private OpenDental.UI.ListBoxOD listStatus5;
		private System.Windows.Forms.ComboBox comboBillType1;
		private System.Windows.Forms.ComboBox comboBillType2;
		private System.Windows.Forms.ComboBox comboBillType3;
		private System.Windows.Forms.ComboBox comboBillType4;
		private System.Windows.Forms.ComboBox comboBillType5;
		...
		private OpenDental.UI.ComboBoxClinicPicker comboClinic5;
		private OpenDental.UI.ComboBoxClinicPicker comboClinic4;
		private OpenDental.UI.ComboBoxClinicPicker comboClinic3;
		private OpenDental.UI.ComboBoxClinicPicker comboClinic2;
		private OpenDental.UI.ComboBoxClinicPicker comboClinic1;
		private System.Windows.Forms.Label labelWirelessPhone;
		private ValidPhone textWirelessPhone1;
		private ValidPhone textWirelessPhone2;
		private ValidPhone textWirelessPhone3;

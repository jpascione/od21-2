	...
	public partial class FormPayment:FormODBase {
      ...
      FormPSE.ListSplitsCur=_listSplitsCur;
		...
		private void CellClickHelper(GridOD grid) {
			...
			if(grid==gridCharges && !checkPayTypeNone.Checked) {
		...
		private void CheckUIState() {
			...
			if(_xProg==null || progPayConnect==null || progPaySimple==null || progCareCredit==null) {//Should not happen.
			...
			if(!progEdgeExpress.Enabled && !_xProg.Enabled) {
				panelEdgeExpress.Visible=true;
			}
		}

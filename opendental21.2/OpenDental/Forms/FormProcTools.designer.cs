...
namespace OpenDental {
    ...
    "he obsolete category.";
			...
			this.checkDcodes.Text = "D codes - Add any missing 2021 ADA codes and fix descriptions and abbreviations o" +
    "f existing codes.  This option does not work in the trial version or compiled ve" +
    "rsion.";

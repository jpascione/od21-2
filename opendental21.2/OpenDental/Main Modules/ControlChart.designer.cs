namespace OpenDental {
	partial class ControlChart {
		...
		private void InitializeComponent(){
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ControlChart));
			...
			this.menuItemSetEC = new System.Windows.Forms.MenuItem();
			this.menuItemSetEO = new System.Windows.Forms.MenuItem();
			...
			this.menuItemGroupMultiVisit = new System.Windows.Forms.MenuItem();
			this.menuItemViewMultiVisitGroup = new System.Windows.Forms.MenuItem();
			...
			this.labelSearchClear = new System.Windows.Forms.Label();
			...
			this.gridChartViews = new OpenDental.UI.GridOD();
			this.textSearch = new OpenDental.ODtextBox();
			this.tabDraw = new System.Windows.Forms.TabPage();
			this.radioMoveText = new System.Windows.Forms.RadioButton();
			...
			this.panelGridProg = new System.Windows.Forms.Panel();
			this.gridProg = new OpenDental.UI.GridOD();
			...
			this.panelToothTrackBar.SuspendLayout();
			this.panelTPpriority.SuspendLayout();
			this.panelGridProg.SuspendLayout();
			this.SuspendLayout();
			// 
			// textSurf
			// 
			...
			this.listDx.SelectionChangeCommitted += new System.EventHandler(this.listDx_SelectionChangeCommitted);
			// 
			// labelDx
			// 
			...
			this.checkAudit.Location = new System.Drawing.Point(169, 180);
			this.checkAudit.Name = "checkAudit";
			this.checkAudit.Size = new System.Drawing.Size(128, 13);
			...
			this.checkShowTeeth.Location = new System.Drawing.Point(15, 121);
			this.checkShowTeeth.Name = "checkShowTeeth";
			this.checkShowTeeth.Size = new System.Drawing.Size(102, 13);
			...
			this.checkRx.Location = new System.Drawing.Point(10, 125);
			...
			// menuItemSetEC
			// 
			this.menuItemSetEC.Index = 2;
			this.menuItemSetEC.Text = "Set Existing Current ";
			this.menuItemSetEC.Click += new System.EventHandler(this.menuItemSetEC_Click);
			// 
			// menuItemSetEO
			// 
			this.menuItemSetEO.Index = 3;
			this.menuItemSetEO.Text = "Set Existing Other";
			this.menuItemSetEO.Click += new System.EventHandler(this.menuItemSetEO_Click);
			// 
			// menuItemEditSelected
			// 
			this.menuItemEditSelected.Index = 4;
			...
			// 
			this.menuItemGroupSelected.Index = 5;
			...
			// menuItemPrintProg
			// 
			this.menuItemPrintProg.Index = 6;
			...
			// 
			this.menuItemLabFeeDetach.Index = 8;
			...
			// 
			this.menuItemPrintRouteSlip.Index = 10;
			...
			// 
			// menuItemGroupMultiVisit
			// 
			this.menuItemGroupMultiVisit.Index = 11;
			this.menuItemGroupMultiVisit.Text = "Group for Multiple Visits";
			this.menuItemGroupMultiVisit.Click += new System.EventHandler(this.menuItemGroupMultiVisit_Click);
			// 
			// menuItemViewMultiVisitGroup
			// 
			this.menuItemViewMultiVisitGroup.Index = 12;
			this.menuItemViewMultiVisitGroup.Text = "View Multivisit Group(s)";
			this.menuItemViewMultiVisitGroup.Click += new System.EventHandler(this.menuItemViewMultiVisitGroup_Click);
			// 
			// tabControlImages
			// 
			...
			this.comboPrognosis.SelectionChangeCommitted += new System.EventHandler(this.ComboPrognosis_SelectionChangeCommitted);
			// 
			// labelPrognosis
			// 
			...
			// tabMissing
			// 
			this.tabMissing.Controls.Add(this.butMixed);
			this.tabMissing.Controls.Add(this.butAllPerm);
			this.tabMissing.Controls.Add(this.butAllPrimary);
			this.tabMissing.Controls.Add(this.groupBox5);
			...
			// butUnhide
			// 
			this.butUnhide.Location = new System.Drawing.Point(119, 156);
			...
			// listHidden
			//
			this.listHidden.Location = new System.Drawing.Point(19, 156);
			...
			// butNotMissing
			// 
			this.butNotMissing.Location = new System.Drawing.Point(7, 43);
			...
			// butMissing
			// 
			this.butMissing.Location = new System.Drawing.Point(7, 17);
			...
			// butHidden
			// 
			this.butHidden.Location = new System.Drawing.Point(7, 70);
			...
			// butEdentulous
			// 
			this.butEdentulous.Location = new System.Drawing.Point(19, 109);
			...
			// tabMovements
			// 
			this.tabMovements.Controls.Add(this.groupBox9);
			...
			this.groupBox9.Size = new System.Drawing.Size(129, 81);
			this.groupBox9.TabIndex = 34;
			this.groupBox9.TabStop = false;
			this.groupBox9.Text = "Clear Movements";
			// 
			// butClearSelectedMovements
			// 
			this.butClearSelectedMovements.Location = new System.Drawing.Point(24, 20);
			this.butClearSelectedMovements.Name = "butClearSelectedMovements";
			this.butClearSelectedMovements.Size = new System.Drawing.Size(85, 23);
			this.butClearSelectedMovements.TabIndex = 33;
			this.butClearSelectedMovements.Text = "Selected Teeth";
			this.butClearSelectedMovements.Click += new System.EventHandler(this.butClearSelectedMovements_Click);
			// 
			// butClearAllMovements
			// 
			this.butClearAllMovements.Location = new System.Drawing.Point(24, 49);
			this.butClearAllMovements.Name = "butClearAllMovements";
			this.butClearAllMovements.Size = new System.Drawing.Size(85, 23);
			this.butClearAllMovements.TabIndex = 32;
			this.butClearAllMovements.Text = "All Teeth";
			...
			this.tabShow.Controls.Add(this.checkShowCommAuto);
			this.tabShow.Controls.Add(this.labelSearchClear);
			this.tabShow.Controls.Add(this.label23);
			...
			this.tabShow.Controls.Add(this.textSearch);
			...
			// checkShowCommAuto
			// 
			this.checkShowCommAuto.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.checkShowCommAuto.Location = new System.Drawing.Point(169, 164);
			this.checkShowCommAuto.Name = "checkShowCommAuto";
			this.checkShowCommAuto.Size = new System.Drawing.Size(128, 13);
			this.checkShowCommAuto.TabIndex = 70;
			this.checkShowCommAuto.Text = "Show Auto Commlogs";
			this.checkShowCommAuto.UseVisualStyleBackColor = false;
			this.checkShowCommAuto.Click += new System.EventHandler(this.checkShowCommAuto_Click);
			// 
			// labelSearchClear
			// 
			this.labelSearchClear.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.labelSearchClear.Location = new System.Drawing.Point(274, 215);
			this.labelSearchClear.Margin = new System.Windows.Forms.Padding(0);
			this.labelSearchClear.Name = "labelSearchClear";
			this.labelSearchClear.Size = new System.Drawing.Size(12, 13);
			this.labelSearchClear.TabIndex = 69;
			this.labelSearchClear.Text = "X";
			this.labelSearchClear.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.labelSearchClear.Visible = false;
			this.labelSearchClear.Click += new System.EventHandler(this.labelSearchClear_Click);
			// 
			// label23
			// 
			this.label23.Location = new System.Drawing.Point(3, 216);
			...
			this.checkTPChart.Location = new System.Drawing.Point(169, 196);
			this.checkTPChart.Name = "checkTPChart";
			this.checkTPChart.Size = new System.Drawing.Size(128, 13);
			...
			this.textShowDateRange.Location = new System.Drawing.Point(6, 171);
			...
			this.labelCustView.Location = new System.Drawing.Point(346, 217);
			...
			this.groupBox7.Location = new System.Drawing.Point(159, 4);
			...
			this.checkCommSuperFamily.Location = new System.Drawing.Point(26, 62);
			...
			this.checkSheets.Location = new System.Drawing.Point(10, 140);
			...
			this.checkTasks.Location = new System.Drawing.Point(10, 78);
			...
			this.checkEmail.Location = new System.Drawing.Point(10, 94);
			...
			this.checkLabCase.Location = new System.Drawing.Point(10, 109);
			...
			// butShowDateRange
			// 
			this.butShowDateRange.Location = new System.Drawing.Point(133, 169);
			...
			this.butChartViewDown.Location = new System.Drawing.Point(426, 188);
			...
			this.butChartViewUp.Location = new System.Drawing.Point(367, 188);
			...
			// butChartViewAdd
			// 
			this.butChartViewAdd.Icon = OpenDental.UI.EnumIcons.Add;
			this.butChartViewAdd.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butChartViewAdd.Location = new System.Drawing.Point(303, 188);
			...
			// butShowAll
			// 
			this.butShowAll.Location = new System.Drawing.Point(6, 141);
			...
			// butShowNone
			// 
			this.butShowNone.Location = new System.Drawing.Point(69, 141);
			...
			// textSearch
			// 
			this.textSearch.AcceptsTab = true;
			this.textSearch.BackColor = System.Drawing.SystemColors.Window;
			this.textSearch.DetectLinksEnabled = false;
			this.textSearch.DetectUrls = false;
			this.textSearch.Location = new System.Drawing.Point(47, 213);
			this.textSearch.Multiline = false;
			this.textSearch.Name = "textSearch";
			this.textSearch.QuickPasteType = OpenDentBusiness.QuickPasteType.TreatPlan;
			this.textSearch.ScrollBars = System.Windows.Forms.RichTextBoxScrollBars.Vertical;
			this.textSearch.Size = new System.Drawing.Size(241, 20);
			this.textSearch.SpellCheckIsEnabled = false;
			this.textSearch.TabIndex = 67;
			this.textSearch.Text = "";
			this.textSearch.TextChanged += new System.EventHandler(this.textSearch_TextChanged);
			// 
			// tabDraw
			// 
			this.tabDraw.Controls.Add(this.label24);
			this.tabDraw.Controls.Add(this.radioMoveText);
			this.tabDraw.Controls.Add(this.butAddText);
			this.tabDraw.Controls.Add(this.butDeleteText);
			this.tabDraw.Controls.Add(this.label1);
			this.tabDraw.Controls.Add(this.listBoxText);
			...
			// radioMoveText
			// 
			this.radioMoveText.Location = new System.Drawing.Point(201, 32);
			this.radioMoveText.Name = "radioMoveText";
			this.radioMoveText.Size = new System.Drawing.Size(95, 17);
			this.radioMoveText.TabIndex = 25;
			this.radioMoveText.TabStop = true;
			this.radioMoveText.Text = "Move Text";
			this.radioMoveText.UseVisualStyleBackColor = true;
			this.radioMoveText.Click += new System.EventHandler(this.radioMoveText_Click);
			// 
			// butAddText
			// 
			this.butAddText.Icon = OpenDental.UI.EnumIcons.Add;
			this.butAddText.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butAddText.Location = new System.Drawing.Point(332, 195);
			this.butAddText.Name = "butAddText";
			this.butAddText.Size = new System.Drawing.Size(71, 22);
			this.butAddText.TabIndex = 24;
			this.butAddText.Text = "Add";
			this.butAddText.Click += new System.EventHandler(this.butAddText_Click);
			// 
			// butDeleteText
			// 
			this.butDeleteText.Icon = OpenDental.UI.EnumIcons.DeleteX;
			this.butDeleteText.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butDeleteText.Location = new System.Drawing.Point(425, 195);
			this.butDeleteText.Name = "butDeleteText";
			this.butDeleteText.Size = new System.Drawing.Size(71, 22);
			this.butDeleteText.TabIndex = 23;
			this.butDeleteText.Text = "Delete";
			this.butDeleteText.Click += new System.EventHandler(this.butDeleteText_Click);
			// 
			// label1
			// 
			...
			// listBoxText
			// 
			this.listBoxText.Location = new System.Drawing.Point(332, 29);
			this.listBoxText.Name = "listBoxText";
			this.listBoxText.Size = new System.Drawing.Size(164, 160);
			this.listBoxText.TabIndex = 21;
			this.listBoxText.DoubleClick += new System.EventHandler(this.listBoxText_DoubleClick);
			// 
			// radioColorChanger
			// 
			this.radioColorChanger.Location = new System.Drawing.Point(201, 86);
			this.radioColorChanger.Name = "radioColorChanger";
			this.radioColorChanger.Size = new System.Drawing.Size(95, 17);
			this.radioColorChanger.TabIndex = 5;
			this.radioColorChanger.TabStop = true;
			this.radioColorChanger.Text = "Change Color";
			...
			this.groupBox8.Location = new System.Drawing.Point(14, 9);
			...
			this.butColorOther.Size = new System.Drawing.Size(50, 22);
			...
			this.panelDrawColor.Location = new System.Drawing.Point(200, 114);
			...
			// radioEraser
			// 
			this.radioEraser.Location = new System.Drawing.Point(201, 68);
			this.radioEraser.Name = "radioEraser";
			this.radioEraser.Size = new System.Drawing.Size(95, 17);
			...
			// radioPen
			// 
			this.radioPen.Location = new System.Drawing.Point(201, 50);
			this.radioPen.Name = "radioPen";
			this.radioPen.Size = new System.Drawing.Size(95, 17);
			...
			this.radioPointer.Location = new System.Drawing.Point(201, 14);
			this.radioPointer.Name = "radioPointer";
			this.radioPointer.Size = new System.Drawing.Size(95, 17);
			...
			this.listPriorities.SelectionMode = UI.SelectionMode.None;
			this.listPriorities.Size = new System.Drawing.Size(70, 43);
			this.listPriorities.TabIndex = 212;
			this.listPriorities.MouseClick += new System.Windows.Forms.MouseEventHandler(this.listPriorities_MouseClick);
			// 
			// menuOrthoChart
			// 
			...
			this.trackToothProcDates.Location = new System.Drawing.Point(76, 0);
			...
			// textToothProcDate
			// 
			this.textToothProcDate.Location = new System.Drawing.Point(0, 0);
			this.textToothProcDate.Name = "textToothProcDate";
			this.textToothProcDate.Size = new System.Drawing.Size(76, 27);
			...
			this.panelToothTrackBar.Controls.Add(this.trackToothProcDates);
			this.panelToothTrackBar.Location = new System.Drawing.Point(0, 334);
			this.panelToothTrackBar.Name = "panelToothTrackBar";
			this.panelToothTrackBar.Size = new System.Drawing.Size(410, 27);
			this.panelToothTrackBar.TabIndex = 214;
			// 
			// panelTPpriority
			// 
			this.panelTPpriority.Controls.Add(this.listPriorities);
			this.panelTPpriority.Controls.Add(this.label4);
			this.panelTPpriority.Location = new System.Drawing.Point(861, 479);
			this.panelTPpriority.Name = "panelTPpriority";
			this.panelTPpriority.Size = new System.Drawing.Size(75, 60);
			this.panelTPpriority.TabIndex = 217;
			// 
			// panelGridProg
			// 
			this.panelGridProg.Controls.Add(this.gridProg);
			this.panelGridProg.Controls.Add(this.gridProgPageNav);
			this.panelGridProg.Location = new System.Drawing.Point(415, 288);
			this.panelGridProg.Name = "panelGridProg";
			this.panelGridProg.Size = new System.Drawing.Size(520, 140);
			this.panelGridProg.TabIndex = 218;
			// 
			// gridProg
			// 
			...
			this.gridProg.PagingMode = OpenDental.UI.GridOD.GridPagingMode.EnabledBottomUp;
			...
			this.gridProgPageNav.Grid = this.gridProg;
			this.gridProgPageNav.Location = new System.Drawing.Point(0, 111);
			this.gridProgPageNav.MinimumSize = new System.Drawing.Size(143, 26);
			this.gridProgPageNav.Name = "gridProgPageNav";
			this.gridProgPageNav.Size = new System.Drawing.Size(520, 26);
			this.gridProgPageNav.TabIndex = 218;
			// 
			// gridTpProcs
			// 
			...
			this.butNewTP.Size = new System.Drawing.Size(77, 22);
			...
			this.gridPtInfo.MouseDown += new System.Windows.Forms.MouseEventHandler(this.gridPtInfo_MouseDown);
			// 
			// textTreatmentNotes
			// 
			...
			// label24
			// 
			this.label24.Location = new System.Drawing.Point(176, 149);
    ...
    "ally for procedures with a PaintType of Text)";
			...
			// ControlChart
			// 
			this.Controls.Add(this.panelGridProg);
			this.Controls.Add(this.gridTpProcs);
			...
			this.panelToothTrackBar.ResumeLayout(false);
			this.panelTPpriority.ResumeLayout(false);
			this.panelGridProg.ResumeLayout(false);
		...
		private OpenDental.UI.ListBoxOD listDx;
		...
		private System.Windows.Forms.MenuItem menuItemSetComplete;
		private System.Windows.Forms.MenuItem menuItemEditSelected;
		private System.Windows.Forms.MenuItem menuItemGroupSelected;
		private OpenDental.UI.Button butPin;
		private OpenDental.UI.ListBoxOD listButtonCats;
		...
		private System.Windows.Forms.TabControl tabProc;
		private System.Windows.Forms.TabPage tabEnterTx;
		...
		private OpenDental.UI.GridOD gridPtInfo;
		private System.Windows.Forms.CheckBox checkComm;
		private System.Windows.Forms.MenuItem menuItemPrintDay;
		private System.Windows.Forms.CheckBox checkAudit;
		private System.Windows.Forms.MenuItem menuItemLabFee;
		private System.Windows.Forms.MenuItem menuItemLabFeeDetach;
		private System.Windows.Forms.MenuItem menuItemPrintRouteSlip;
		...
		private System.Windows.Forms.CheckBox checkCommFamily;
		private OpenDental.UI.Button butForeignKey;
		private System.Windows.Forms.CheckBox checkTasks;
		private System.Windows.Forms.CheckBox checkEmail;
		private System.Windows.Forms.CheckBox checkSheets;
		...
		private System.Windows.Forms.Panel panelRdark;
		private System.Windows.Forms.Label label21;
		private System.Windows.Forms.Panel panelRlight;
		private System.Windows.Forms.Panel panelEOdark;
		private System.Windows.Forms.Label label20;
		private System.Windows.Forms.Panel panelEOlight;
		private System.Windows.Forms.Panel panelECdark;
		private System.Windows.Forms.Label label19;
		private System.Windows.Forms.Panel panelEClight;
		private System.Windows.Forms.Panel panelCdark;
		private System.Windows.Forms.Label label17;
		private System.Windows.Forms.Panel panelClight;
		private System.Windows.Forms.RadioButton radioColorChanger;
		private System.Windows.Forms.Panel panelBlack;
		private System.Windows.Forms.Label label22;
		private OpenDental.UI.GridOD gridPlanned;
		private System.Windows.Forms.ContextMenu menuConsent;
		private System.Windows.Forms.RadioButton radioEntryCn;
		private System.Windows.Forms.CheckBox checkShowCn;
		private System.Windows.Forms.WebBrowser webBrowserEcw;
		private System.Windows.Forms.Panel panelEcw;
		private System.Windows.Forms.Label labelECWerror;
		private System.Windows.Forms.ContextMenu menuToothChart;
		private System.Windows.Forms.MenuItem menuItemChartBig;
		private System.Windows.Forms.MenuItem menuItemChartSave;
		...
		private System.Windows.Forms.TabPage tabPatInfo;
		...
		private OpenDental.UI.ListBoxOD listCommonProcs;
		...
		private System.Windows.Forms.CheckBox checkTreatPlans;
		private OpenDental.UI.GridOD gridTreatPlans;
		private OpenDental.UI.GridOD gridTpProcs;
		private System.Windows.Forms.Label label4;
		private OpenDental.UI.ListBoxOD listPriorities;
		private UI.Button butNewTP;
		private System.Windows.Forms.CheckBox checkTPChart;
		private System.Windows.Forms.ContextMenu menuOrthoChart;
		...
		private System.Windows.Forms.Panel panelToothTrackBar;
		private System.Windows.Forms.Panel panelTPpriority;
		private OpenDental.UI.ODGridPageNav gridProgPageNav;
		private OpenDental.UI.GridOD gridProg;
		...
		private System.Windows.Forms.MenuItem menuItemViewMultiVisitGroup;
		...
		private UI.ListBoxOD listBoxText;
		private System.Windows.Forms.RadioButton radioMoveText;
		private UI.Button butAddText;

	...
	public partial class SmsThreadView:UserControl {
		...
		private void FillMessageThread() {
			...
			for(int i=0;i<_listSmsThreadToDisplay.Count;i++) {
				...
				textBoxMessage.MouseUp+=TextBoxMessage_MouseUp;
				...
				textBoxMessage.Location=new Point(1,1);//Shows flat "border" around a RichTextBox.
				...
				LayoutManager.Add(textBoxMessage,border);
				y+=border.Height;
			}
		...
		private void TextBoxMessage_MouseUp(object sender,MouseEventArgs e) {
			...
			if(e.Button==System.Windows.Forms.MouseButtons.Right) {
				...
				menuItem.Click+=(o,e) => Clipboard.SetText(richTextBox.SelectedText);;

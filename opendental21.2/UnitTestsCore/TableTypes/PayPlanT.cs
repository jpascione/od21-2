...
namespace UnitTestsCore {
	public class PayPlanT {
		...
		public static PayPlan CreateDynamicPaymentPlan(long patNum,long guarantorNum,DateTime date,double downPaymentAmt,int APR,double payAmt,
			...
			DateTime dateInterestStart=default,long provNum=0,int payCount=0,bool isNextPeriodOnly=true)
		{
			...
			listCharges.AddRange(PayPlanEdit.GetListExpectedCharges(new List<PayPlanCharge>(),terms,fam,listPayPlanLinks,payPlan,isNextPeriodOnly
